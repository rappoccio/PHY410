...
#define SWIG_init    Slope_Init
#define SWIG_name    "slope"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_getSlope(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  float arg1 ;
  float arg2 ;
  float arg3 ;
  float arg4 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oooo:getSlope x0 y0 x1 y1 ",(void *)0,(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "getSlope" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = (float)(val1);
  ecode2 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "getSlope" "', argument " "2"" of type '" "float""'");
  } 
  arg2 = (float)(val2);
  ecode3 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[3], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "getSlope" "', argument " "3"" of type '" "float""'");
  } 
  arg3 = (float)(val3);
  ecode4 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[4], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "getSlope" "', argument " "4"" of type '" "float""'");
  } 
  arg4 = (float)(val4);
  result = (float)getSlope(arg1,arg2,arg3,arg4);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "getSlope", (swig_wrapper_func) _wrap_getSlope, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Slope_SafeInit(Tcl_Interp *interp) {
